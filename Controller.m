...
+(void) initialize
{
    ...
    [defaultValues setObject:[NSNumber numberWithDouble:120*1024]
					  forKey:NIGlobalSpeedLimitDownload];

    [defaultValues setObject:[NSNumber numberWithDouble:30*1024]
					  forKey:NIGlobalSpeedLimitUpload];
